	...
	<table>
		<tr>
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					<br>
					Teléfono: 416 781 32 10
					<br>
					wasllotdev@gmail.com
				</div>
		...
		<tr>
			...
			<td style="width: 100%; items-align:center; margin-top: 1rem;">
...
$bloque2 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:240px">Cliente: $respuestaCliente[nombre]</td>		
		<td style="border: 1px solid #666; background-color:white; width:150px">C.I: $respuestaCliente[documento]</td>
